...
void ActsGeometryProvider::initialize(const std::string& geometry_file,
    ...
    m_init_log->debug("ActsGeometryProvider initialization");
    ...
    //   Acts::GeometryIdentifier decorateIdentifier(Acts::GeometryIdentifier identifier, const Acts::Surface& surface) const {
    //     const auto* dd4hep_det_element = dynamic_cast<const Acts::DD4hepDetectorElement*>(surface.associatedDetectorElement());
    ...
    // Visit surfaces
    // TODO 2 Revisit this surface checking
